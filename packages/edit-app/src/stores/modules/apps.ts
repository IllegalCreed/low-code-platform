...
export const useAppsStore = defineStore('apps', () => {
  const apps = ref([
    {
      id: uuidv4(),
      name: 'Application One with a significantly longer name',
      color: getRandomColor(),
    },
    { id: uuidv4(), name: 'Short name', color: getRandomColor() },
    {
      id: uuidv4(),
      name: 'Data Analyzer with additional descriptive text',
      color: getRandomColor(),
    },
    ...
    {
      id: uuidv4(),
      name: 'Content Delivery Network and Services Platform',
      color: getRandomColor(),
    },
    {
      id: uuidv4(),
      name: 'Advanced Configuration and Setup Tool for Network Devices',
      color: getRandomColor(),
    },
  ]);
